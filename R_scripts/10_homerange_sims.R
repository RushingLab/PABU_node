...
for (i in 1:nrow(locations_filtered1)){
    ...
    sample_size <- 100 # sample each point 100 times 
...
saveRDS(estimated.location_results, paste0(outpath, "Simulated.Locations100.HomeRange.90p-90.locs.filtered1_", START, "_", END, ".rds"))